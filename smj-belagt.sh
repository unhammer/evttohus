...
ana () {
    lang=$1
    preprocess --abbr=$GTHOME/langs/${lang}/tools/preprocess/abbr.txt|lookup -q $GTHOME/langs/${lang}/src/analyser-gt-desc.xfst
}
...
xmlstarlet sel -t -m '//e[@src="fad"]/lg/l/text()' -c . -n $GTHOME/words/dicts/smenob/src/V*.xml >/tmp/fad-verb.sme
xmlstarlet sel -t -m '//e[@src="fad"]/lg/l/text()' -c . -n $GTHOME/words/dicts/smenob/src/[^V]*.xml >/tmp/fad-nonverb.sme
